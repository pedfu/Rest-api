...
async function createTable() {
    ...
    await db.query("CREATE TABLE evento (id serial PRIMARY KEY, nome VARCHAR(20) UNIQUE NOT NULL)")

    await db.query("CREATE TABLE participante (id serial PRIMARY KEY, nome VARCHAR(20) UNIQUE NOT NULL)")
